      ...
      <div className="bg-white border-b border-slate-200 sticky top-[52px] z-40">
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex gap-1 py-2">
            ...
            {/* SPAS.3 — external link to /admin/surgical-risk */}
            <Link
              href={`/admin/surgical-risk${key ? `?key=${encodeURIComponent(key)}` : ''}`}
              className="flex items-center gap-1.5 px-4 py-2 rounded-lg text-sm font-medium text-slate-600 hover:bg-slate-100 transition-all border border-dashed border-slate-300"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              Surgical Risk Config
